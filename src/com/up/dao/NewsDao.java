...
public class NewsDao extends  JDBCTemplates<News> {
	//根据状态查询公告
		 ...
		 public List<News> sreachNewsState(String issuer, String a, String b, String c, String d, int pageNum) {
				String sql=null;
				String kind="新闻";
				String state="草稿";
					if(a!=""){
						sql="SELECT * FROM News as a where a.issuer =?  and a.kind=? and state!=?";
		 ...
		 //app端
		public List<News> sreachNewsState3(String a, String b, String c, String d, int pageNum) {
