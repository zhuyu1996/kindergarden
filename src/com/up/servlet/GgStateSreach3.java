 ...
 */
@WebServlet("/GgStateSreach3")
public class GgStateSreach3 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GgStateSreach3() {
        super();
...
//			   E = new String(E.getBytes("GB2312"),"utf-8"); 
	...
	System.out.println(A+" "+B+" "+C+" "+D);
		try {
			List <News> News=GgServiceimpl.sreachGgState3(A, B, C, D,pageNum);
