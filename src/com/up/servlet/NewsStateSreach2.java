 ...
 */
@WebServlet("/NewsStateSreach2")
public class NewsStateSreach2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NewsStateSreach2() {
        super();
...
//				   E = new String(E.getBytes("GB2312"),"utf-8");
		...
		System.out.println(A+" "+B+" "+C+" "+D);
			try {
				List <News> News=newserviceimpl.sreachNewsState(issuer,A, B, C, D,pageNum);
