 ...
 */
@WebServlet("/AllStateSreach")
public class AllStateSearch extends HttpServlet {
...
//				   E = new String(E.getBytes("GB2312"),"utf-8");  
		...
		System.out.println(A+" "+B+" "+C+" "+D+" "+pageNum);
			try {
				List <News> News=allServiceImpl.sreachAllState(A, B, C, D,pageNum);
