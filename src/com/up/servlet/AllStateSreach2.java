 ...
 */
@WebServlet("/AllStateSreach2")
public class AllStateSreach2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AllStateSreach2() {
        super();
...
//				   E = new String(E.getBytes("GB2312"),"utf-8");   
		...
		System.out.println(A+"  "+B+"  "+C+"  "+D);
			try {
				List <News> News=allServiceImpl.sreachAllState(issuer,A, B, C, D,pageNum);
