...
/**
 * Servlet implementation class PictureContentShowteacher
 */
@WebServlet("/PCtShowteacher")
public class PictureContentShowteacher extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<PictureContent> picturecontentlist=picturecontent.showppiccontentteacher(pageNumi,teachercid);
