...
/**
 * Servlet implementation class TeacherBymoniter
 * 职务为班长的老师名
 */
@WebServlet("/TeacherBymoniter")
public class TeacherBymoniter extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	    //所有数据
			List<Teacher> listteacher=teacherservice.showbymonitor();
