...
/**
 * Servlet implementation class MovieContentClassApp
 */
@WebServlet("/MCClassApp")
public class MovieContentClassApp extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			Paging paging=moviecontentservieimpl.showMCByclassApp(classid,pageNumi);
