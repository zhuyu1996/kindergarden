...
/**
 * Servlet implementation class TeacherByBaoyu
 * 职务为保育员的老师名
 */
@WebServlet("/TeacherByBaoyu")
public class TeacherByBaoyu extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	    //所有数据
			List<Teacher> listteacher=teacherservice.showbyBaoYu();
