...
public class ChangeTeacher {
	...
	private String tId;
	public ChangeTeacher(String tId, String tName, String tPhone, String tSex, String tWorkId, String cId,
			String tgrade, String tface, String pictureContentid, String movieContentid) {
		super();
		this.tId = tId;
		this.tName = tName;
		this.tPhone = tPhone;
	...
	public String toString() {
		return "ChangeTeacher [tId=" + tId + ", tName=" + tName + ", tPhone=" + tPhone + ", tSex=" + tSex + ", tWorkId="
				+ tWorkId + ", cId=" + cId + ", tgrade=" + tgrade + ", tface=" + tface + ", pictureContentid="
