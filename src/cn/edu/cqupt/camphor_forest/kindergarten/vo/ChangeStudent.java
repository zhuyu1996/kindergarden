...
public class ChangeStudent {
	...
	public ChangeStudent(String sSex, String sName, String sIdentifyId, String sComeAge, String cId, String sComeTime,
			String sAcount, String sPassword, String sId, String sAddress, String sFace, String pictureContentid,
	...
	public String toString() {
		return "ChangeStudent [sSex=" + sSex + ", sName=" + sName + ", sIdentifyId=" + sIdentifyId + ", sComeAge="
				+ sComeAge + ", cId=" + cId + ", sComeTime=" + sComeTime + ", sAcount=" + sAcount + ", sPassword="
				+ sPassword + ", sId=" + sId + ", sAddress=" + sAddress + ", sFace=" + sFace + ", pictureContentid="
				+ pictureContentid + ", movieContentid=" + movieContentid + "]";
	}
