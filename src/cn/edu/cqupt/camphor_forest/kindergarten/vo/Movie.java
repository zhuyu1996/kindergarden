...
public class Movie {
	...
	public String toString() {
		return "Movie [mvDate=" + mvDate + ", mvId=" + mvId + ", mvAdress=" + mvAdress + ", mvLike=" + mvLike
				+ ", mcId=" + mcId + ", mface=" + mface + "]";
	}
	public Movie(String mvDate, String mvId, String mvAdress, String mvLike, String mcId, String mface) {
		super();
		this.mvDate = mvDate;
		this.mvId = mvId;
